...
- **Jenny** contributed to 热学、理论力学、线性代数（B）
---

## 📢 What's New
- **12.22** 更新了理论力学、线性代数（B）笔记，期末季加油！
- **10.30** 修复了网站部分笔记无法显示的问题，目前所有笔记均可正常获取。
- **10.30** CourseCommunity在此祝各位期中考试顺利！我们在期中季后也会进行一次笔记征集&网站优化！
- **9.13** *qsgg 100stars女装兑现，详见仓库内照片！*
- **9.13** 娄峻赫学长的中宏、中微、中经专、经原笔记发布！作为北京大学最为欢迎的经济学笔记，我们很高兴能得到学长的首肯~
- **我们联系到了多位数院的优秀助教，获得了众多优秀笔记的授权，详情请密切跟进我们的公众号动态~**
- **9.4** 马艺铭学长的线性代数（B）笔记发布！作为北京大学最为欢迎的线性代数笔记，我们很高兴能得到学长官方的首肯~
